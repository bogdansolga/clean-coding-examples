...
import com.cerner.augero.common.events.domain.patientadmin.encounter.EncounterCancelledAugeroDomainEventV1;
...
/**
 * Class used to produce a {@link EncounterCancelledAugeroDomainEventV1}
 */
@NoArgsConstructor(access = AccessLevel.PRIVATE)
public abstract class AugeroEncounterCancelledEventProducer {
    ...
    public static EncounterCancelledAugeroDomainEventV1 produce(Encounter encounter) {
        ...
        return new EncounterCancelledAugeroDomainEventV1(eventData, PATIENT_ADMIN_SOURCE);
    }
